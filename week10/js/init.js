...
let layers = {
    "Vaccinated cool peeps <svg height='10' width='10'><circle cx='5' cy='5' r='4' stroke='black' stroke-width='1' fill='red' /></svg>": vaccinated,
...
vaccinatedCheckbox.addEventListener("click",toggleNonVaccinatedLayer)
nonVaccinatedCheckbox.addEventListener("click",toggleVaccinatedLayer)
